...
class NFAMatchEntriesShadowGenerator():
    def __init__(self, pattern_expression, stride=1, table_id_list=[0]):
        ...
        self.runtime_mat_default_entries = \
                self.generate_runtime_mat_default_entries(self.nfa_shadow_default_entry, self.table_id_list)
...
if __name__ == '__main__':
    ...
    # get_tree
    x = NFAMatchEntriesShadowGenerator("she | he | her ", stride=4,table_id_list=[0,1,2])
